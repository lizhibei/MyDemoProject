...
public class ImageLoader {
    ...
    public void displayImage(String url,ImageView imageView,int defaultImageResId,int errorImageResId){
        ImageListener imageListener=getImageListener(imageView,defaultImageResId,errorImageResId);
        get(url,imageListener,maxWidth,maxHeight,scaleType);
    }
     ...
     * @param imageListener
     */
    public void getBitmap(String url,ImageListener imageListener){
        get(url,imageListener,maxWidth,maxHeight,scaleType);
    }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        if (cacheBitmap != null) {
            ...
            ImageContainer container = new ImageContainer(cacheBitmap, requestUrl, null,
                    null);
    ...
    public interface ImageListener extends Response.ErrorListener {
         ...
         *
         * @param response
         * @param isImmediate  true 直接从缓存获取   false通过requet请求获取
         */
